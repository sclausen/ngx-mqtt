...
let f ="../../node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/webpack-configs/browser.js";
const cwd = process.cwd();
const packageJsonPath = path.join(cwd, "node_modules/@angular/core/package.json");
if (fs.existsSync(packageJsonPath)) {
  ...
  if (content) {
    ...
    if (version) {
      ...
      if(semv.major>=11){
        f = '../../node_modules/@angular-devkit/build-angular/src/webpack/configs/browser.js';
      }
    }
  }
}
